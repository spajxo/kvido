...
The current working directory is the project context. All `state/` and `memory/` references in skills and agents resolve to `$KVIDO_HOME/state/` and `$KVIDO_HOME/memory/`.
